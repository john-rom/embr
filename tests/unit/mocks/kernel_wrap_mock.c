...
int mock_kernel_wrap_error_work_init_call_count = 0;
int mock_kernel_wrap_error_work_submit_call_count = 0;
int mock_kernel_wrap_error_work_submit_return_value = 0;
int mock_kernel_wrap_error_work_init_conflict_count = 0;
int mock_kernel_wrap_error_work_init_return_value = 0;
...
void kernel_wrap_mock_reset(void) {
  ...
  mock_kernel_wrap_error_work_init_call_count = 0;
  mock_kernel_wrap_error_work_submit_call_count = 0;
  mock_kernel_wrap_error_work_submit_return_value = 0;
  mock_kernel_wrap_error_work_init_conflict_count = 0;
...
int kernel_wrap_error_work_init(kernel_work_handler_t handler) {
  mock_kernel_wrap_error_work_init_call_count++;

  if (mock_kernel_wrap_error_work_init_return_value) {
    return mock_kernel_wrap_error_work_init_return_value;
  }
  ...
  if (mock_kernel_wrap_work_last_handler &&
    ...
    mock_kernel_wrap_error_work_init_conflict_count++;
    return -EALREADY;
  }
  mock_kernel_wrap_work_last_handler = handler;
  return 0;
...
int kernel_wrap_error_work_submit(void) {
  mock_kernel_wrap_error_work_submit_call_count++;
  return mock_kernel_wrap_error_work_submit_return_value;
}
