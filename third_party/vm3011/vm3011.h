...
#define VM3011_PGA_TO_DB(x)                                                    \
  VM3011_PGA_MAX_DB -                                                          \
      ((float)((x) & VM3011_WOS_PGA_GAIN_Msk) * VM3011_PGA_DB_STEPS)
#define VM3011_DB_TO_PGA(x)                                                    \
  (uint8_t)((VM3011_PGA_MAX_DB - (x)) / VM3011_PGA_DB_STEPS)
...
typedef enum { ZPL, STANDBY, LOW_POWER, NORMAL } dmic_op_mode;
